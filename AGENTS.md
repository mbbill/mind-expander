...
- If the same issue still fails after three fix attempts, stop making incremental patches. Re-examine the deeper architecture, algorithm, and product contract; then discuss the intended solution or necessary refactor before implementing another fix.
...
- If this is the third failed attempt at the same issue, did work stop for a deeper analysis and explicit solution discussion?
